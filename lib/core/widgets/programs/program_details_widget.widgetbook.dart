...
Widget buildProgramDetailsWidgetUseCase(BuildContext context) {
  final program = ProgramResponseDto(
    ...
    description: 'Un programa diseñado para potenciar las habilidades de liderazgo en los estudiantes a través de actividades prácticas y proyectos comunitarios de alto impacto.',
    acronym: 'PLU',
    color: '#4287f5',

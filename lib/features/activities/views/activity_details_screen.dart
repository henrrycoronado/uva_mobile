  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return FutureBuilder<ActivityResponseDto>(
      ...
      builder: (context, snapshot) {
        ...
        if (snapshot.hasData) {
          return _ActivityDetailsContent(activity: snapshot.data!);
        }
        return const Scaffold(
...
class _ActivityDetailsContent extends ConsumerWidget {
  final ActivityResponseDto activity;

  const _ActivityDetailsContent({required this.activity});
